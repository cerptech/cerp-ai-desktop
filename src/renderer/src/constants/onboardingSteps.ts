...
export const ONBOARDING_STEPS: OnboardingStepMeta[] = [
  ...
  { id: 2, title: 'Prepará tu data', tagline: 'Tené a mano los archivos que la IA va a usar.', icon: '\u{1F4C1}' },
  { id: 3, title: 'Conectá tu carpeta de trabajo', tagline: 'Apuntá la app a la carpeta donde están tus archivos.', icon: '\u{1F517}' },
  { id: 4, title: 'Tu primer pedido', tagline: 'Elegí un punto de partida y editalo a tu gusto.', icon: '\u{1F4AC}' },
  { id: 5, title: 'Cómo leer la respuesta', tagline: 'Entendé qué te devuelve el agente.', icon: '\u{1F4D6}' },
  { id: 6, title: 'Próximos pasos', tagline: 'Exportá, compartí y refiná tu cotización.', icon: '\u{1F680}' },
]
...
export const ONBOARDING_EXAMPLES: OnboardingExample[] = [
  { icon: '\u{1F4E5}', title: 'Importar catálogo', description: 'Cargá tu catálogo de materiales y recursos desde Excel para tenerlo disponible en tus cotizaciones.' },
  ...
  { icon: '\u{1F4CB}', title: 'Cotizar una licitación', description: 'Analizá un pliego completo y generá el presupuesto con capítulos, ítems y totales.' },
]
...
export const ONBOARDING_CHECKLIST: OnboardingChecklistItem[] = [
  ...
  { label: 'Plantilla de APU', hint: 'Tu formato de Análisis de Precio Unitario, si ya tenés uno.', required: false },
...
export const ONBOARDING_GLOSSARY: OnboardingGlossaryTerm[] = [
  ...
  { term: 'Total', definition: 'La suma de todos los ítems. Revisá que cada capítulo tenga ítems y que el total sea mayor a 0.' },
]

// ── Paso 6: próximos pasos ──
export const ONBOARDING_NEXT_STEPS: string[] = [
  'Exportá tu cotización a PDF para enviarla a tu cliente.',
  'Pedile a la IA que ajuste cantidades, precios o márgenes y volvé a generar.',
  'Adjuntá un PDF al chat para sumarlo a la cotización.',
  'Empezá una nueva conversación para cada obra distinta.',
]
