...
const KNOWN_TOOL_LABELS: Record<string, string> = {
  ...
  get_purchase_order_details: 'Detalle de orden de compra',
  get_classifications: 'Consultando clasificaciones',
  get_contact_types: 'Consultando tipos de contacto',
  ...
  update_purchase_status: 'Actualizando estado de la compra',
